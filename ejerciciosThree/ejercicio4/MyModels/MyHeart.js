...
class MyHeart extends THREE.Object3D {
  constructor() {
    ...
    this.shape.lineTo(1.5,1);
    this.shape.quadraticCurveTo(1.5, 1.75, 0.75, 1.75);
    this.shape.quadraticCurveTo(0, 1.75, 0, 1);
    this.shape.quadraticCurveTo(0, 1.75, -0.75, 1.75);
    this.shape.quadraticCurveTo(-1.5, 1.75, -1.5, 1);;
    ...
    // Para que la geometria quede centrada
    geom.translate(0,0,-prof/2);
